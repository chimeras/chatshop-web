...
MMMM;
	...
	private function _generateRowClass($name)
	{
		...
		$class = "<?php\nclass Application_Model_Db_Row_" . $this->toCamelCase($name) . " extends Zend_Db_Table_Row_Abstract{\n\n";
	...
	private function _generateTableClass($name)
	{
		$class = <<<CLSS
<?php
class Application_Model_Db_Table_{$this->toCamelCase($name)}s extends Zend_Db_Table_Abstract
{
